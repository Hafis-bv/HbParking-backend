...
async function register(req, res, next) {
    try {
        ...
        (0, generateTokenAndSetCookies_1.generateTokenAndSetCookies)(res, newUser.id);
        return res
            .status(200)
...
async function login(req, res, next) {
    try {
        ...
        const token = (0, generateTokenAndSetCookies_1.generateTokenAndSetCookies)(res, user.id);
